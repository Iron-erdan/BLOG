		            ...
		            <article class="article-list bloglist" id="LAY_bloglist" >
						<section class="article-item zoomIn article">       
							...
							<h5 class="title">       
								...
								<a href="read.jsp">.NET Spire.Doc组件</a>
							</h5>   
							<div class="time">       
							...
							<div class="content">       
								<a href="read.jsp" class="cover img-light">
							...
							<div class="read-more">       
								<a href="read.jsp" class="fc-black f-fwb">继续阅读</a>
							</div>    
		        ...
		        <div class="inner">
					<div class="other-item" id="categoryandsearch">
			    		...
			    		<ul class="category mt20" id="category">
				            ...
				            <li data-index="2"><a href="/Blog/Article/1/article.jsp">个人日记</a></li>
				            <li data-index="3"><a href="/Blog/Article/2/article.jsp">HTML5&amp;CSS3</a></li>
				            <li data-index="4"><a href="/Blog/Article/3/article.jsp">JavaScript</a></li>
				            <li data-index="5"><a href="/Blog/Article/4/article.jsp">ASP.NET MVC</a></li>
				            <li data-index="6"><a href="/Blog/Article/5/article.jsp">其它</a></li>
			    		</ul>
					</div>
					<!--右边悬浮 平板或手机设备显示-->
					...
					<div class="article-category">
					    <div class="article-category-title">分类导航</div>
					            <a href="/Blog/Article/1/article.jsp">个人日记</a>
					            <a href="/Blog/Article/2/article.jsp">HTML5&amp;CSS3</a>
					            <a href="/Blog/Article/3/article.jsp">JavaScript</a>
					            <a href="/Blog/Article/4/article.jsp">ASP.NET MVC</a>
					            <a href="/Blog/Article/5/article.jsp">其它</a>
					    <div class="f-cb"></div>
					</div>
					<!--遮罩-->
